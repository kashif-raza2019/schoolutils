...
<table id="u_content_text_4" style="font-family:'Montserrat',sans-serif;" role="presentation" cellpadding="0" cellspacing="0" width="100%" border="0">
  ...
  <div class="v-line-height" style="line-height: 160%; text-align: center; word-wrap: break-word;">
    <p style="font-size: 14px; line-height: 170%;">Your account has been succesfully verified with our records, now you can start using the school utils.</p>
<p style="font-size: 14px; line-height: 170%; text-align: left;">Your Account Information is: </p>
<p style="font-size: 14px; line-height: 170%; text-align: left;"><strong>Name: `;
const m2 = `</strong></p>
<p style="font-size: 14px; line-height: 170%; text-align: left;"><strong>Password:`;
const m3 = ` </strong></p>
<p style="font-size: 14px; line-height: 170%; text-align: left;"><span style="color: #e03e2d; font-size: 14px; line-height: 23.8px;"><strong>Please star this email as it cannot be retrived later, <em>to retrive it again contact to the mailer itself</em>.</strong></span></p>
  </div>
...
function verifiedMail(name, password){
    return m1 + name + m2 + password + m3;
}
