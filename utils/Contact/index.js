...
table, td { color: #000000; } @media (max-width: 480px) { #u_content_image_1 .v-src-width { width: auto !important; } #u_content_image_1 .v-src-max-width { max-width: 96% !important; } #u_content_heading_1 .v-font-size { font-size: 26px !important; } #u_content_text_4 .v-container-padding-padding { padding: 0px 10px 40px !important; } #u_content_text_4 .v-line-height { line-height: 170% !important; } }
    </style>
...
<table id="u_content_heading_1" style="font-family:'Montserrat',sans-serif;" role="presentation" cellpadding="0" cellspacing="0" width="100%" border="0">
  ...
  <h1 class="v-line-height v-font-size" style="margin: 0px; line-height: 140%; text-align: center; word-wrap: break-word; font-weight: normal; font-family: 'Open Sans',sans-serif; font-size: 30px;">
    <div>
<div>
<div><strong>Message is sent to developer</strong></div>
</div>
</div>
  </h1>
...
<table id="u_content_text_4" style="font-family:'Montserrat',sans-serif;" role="presentation" cellpadding="0" cellspacing="0" width="100%" border="0">
  ...
  <div class="v-line-height" style="line-height: 160%; text-align: center; word-wrap: break-word;">
    <p style="font-size: 14px; line-height: 170%;">Thank you for contacting us!, We have recieved your message and will respond to you back within 24 hours.</p>
<p style="font-size: 14px; line-height: 170%; text-align: left;">Your Message Information is: </p>
<p style="font-size: 14px; line-height: 170%; text-align: left;"><strong>Name: `;
const m2 = `</strong></p>
<p style="font-size: 14px; line-height: 170%; text-align: left;">Message:<br />`;
const m3 = ` </p>
<p style="font-size: 14px; line-height: 170%; text-align: left;"><span style="color: #e03e2d; font-size: 14px; line-height: 23.8px;"><strong>Be patient while we will try to get back to you as soon as possible!</em>.</strong></span></p>
  </div>
...
function contactMail(name, message){
    return m1 + name + m2 + message + m3;
}
